...
class VLLMClient(Client):
    def _single_call(
        ...
        # # Create an LLM. #meta-llama/Meta-Llama-3-8B-Instruct
        # llm = LLM(model="TinyLlama/TinyLlama-1.1B-Chat-v1.0", gpu_memory_utilization=0.6,trust_remote_code=True)
        ...
        #     print(f"Generated text: {generated_text!r}")#Prompt: {prompt!r}, 
